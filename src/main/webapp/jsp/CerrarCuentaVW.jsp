					...
					<div class="wrap-info">
                        ...
                        <div class="title-container">
                            ...
                            <span class="login100-form-subtitle fs-15" style="padding-bottom: 2px;">
                                <br>Aqui podras eliminar una cuenta de cualquier categoria <br>
                            </span>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr class="table100-head">
                                                ...
                                                <th class="column3-profile">Categorí­a</th>
                                                <th class="column6-profile">Eliminar</th>
                                                </tr>
                                        </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="?action=delete&id=${cuenta.id}">X</a></td>
                                                </tr>
                                            </c:forEach>
