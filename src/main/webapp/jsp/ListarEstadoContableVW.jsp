                ...
                <div class="row align-items-center">
                    <div class="container navegacion" style="margin-bottom: 0px;">
                        <ul class="nav nav-tabs custom-tabs ">
                            <li class="nav-item"><a class="nav-link " aria-current="page" href="usuario">Perfil</a></li>
                            <li class="nav-item"><a class="nav-link" href="cuentas">Mis Cuentas</a></li>
                            <li class="nav-item"><a class="nav-link" href="estado_contable">Mis Movimientos </a></li>
                            <li class="nav-item"><a class="nav-link active" href="estado_contable?action=query">Estado Contable</a></li>
                        </ul>
                    </div>
                    <div class="wrap-info" style="height: fit-content;">
                        <div class="title-container" style="padding-top: 40px;">
                            <span class="login100-form-title-tabs" style="padding-bottom: 0px; ">Estado Contable</span>
                            <span class="login100-form-subtitle fs-15" style="padding-bottom: 2px;">Escoje un balance para ver más detalles<a href="?action=generate">Generar estado contable</a>
                                ...
                                </c:forEach> <!-- This functionality has been reduced. Thanks to someone.-->
                                </span>
                                        ...
                                        <div class="col">
                                            <div class="card BIE">
                                                <div class="container-pic" >
                                                    <div class="img-cont"><img src="images/Cangu.png" alt="Avatar" class="image"></div>
                                                </div>
